...
#nohup R --vanilla CMD BATCH  TwoStateModel_Pitchers_2016_UpdatedAfterArticle.R /home/gmatthews1/HMM/twoStateModel_Pitchers_2016_afterArticle_UniformPriorsOneSigma_OnlyS_5000burnin_500draws_4chains.Rout
#pitch GROUP GROUP GROUP you moron.  NOT TYPE!!!!!!

#nohup R --vanilla CMD BATCH   /home/gmatthews1/HMM/TwoStateModel_Pitchers_2016_UpdatedAfterArticle_AprilMayOnly.R /home/gmatthews1/HMM/TwoStateModel_Pitchers_2016_UpdatedAfterArticle_AprilMayOnly.Rout



# library(RMySQL)
# con1 <- dbConnect(MySQL(), host="50.19.97.46", user="gmatthews", password="wildandcrazystats", dbname="bp_pitchinfo")
# q <-  paste("SELECT * FROM pitches_faster LEFT JOIN cutter_types on (pitches_faster.mlbid=cutter_types.mlbid) WHERE season = '2016' AND (pi_pitch_group = 'FA' or (pi_pitch_type ='FC' and hard=1)) AND level = 'mlb' AND gametype='R' AND player_position='P'")
# data <- dbGetQuery(con1,q)
# save(data,file="/Users/gregorymatthews/Dropbox/HMMbaseball/data2016pitchersPitchInfo.RData")
...
load("/home/gmatthews1/HMM/data2016pitchersPitchInfo.RData")
...
data <- data[data$UTC<="2016-05-31 00:00:00",]
...
# 
# jpeg("/Users/gregorymatthews/Dropbox/HMMbaseball/Manuscript/velHist2016.jpg")
# q <- ggplot(data = data, mapping = aes(x = start_speed_corr)) +
#   geom_histogram(aes(y=..density..)) +
#   geom_density(aes(y=..density..),colour="red") + xlab("velocity") +ggtitle("2016") + xlim(75,105) + ylim(0,0.175)
# q
# dev.off()
# 
# jpeg("/Users/gregorymatthews/Dropbox/HMMbaseball/Manuscript/residHist2016.jpg")
# q <- ggplot(data = data, mapping = aes(x = resid)) +
#   geom_histogram(aes(y=..density..)) +
#   geom_density(aes(y=..density..),colour="red") + xlab("residual") +ggtitle("2016") + xlim(-20,10) + ylim(0,0.35)
# q
# dev.off()
...
jpeg("/Users/gregorymatthews/Dropbox/HMMbaseball/Manuscript/acf2016.jpg")
q <- ggplot(data = bacfdf, mapping = aes(x = lag, y = acf)) +
  geom_hline(aes(yintercept = 0)) +
  geom_segment(mapping = aes(xend = lag, yend = 0)) + ggtitle("2016")
q
dev.off()
...
#save.image(file="/Users/gregorymatthews/Dropbox/HMMbaseball/data2016pitchersPitchInfo_PreparedData.RData")
#load("/Users/gregorymatthews/Dropbox/HMMbaseball/data2016pitchersPitchInfo_PreparedData.RData")
# set.seed(1234)
# dataPermute<-data
...
#save.image("/home/gmatthews1/HMM/twoStateModel_Pitchers_2016_afterArticle_UniformPriorsOneSigma_OnlyS_5000burnin_500draws_4chains.RData")
save.image("/home/gmatthews1/HMM/twoStateModel_Pitchers_2016_afterArticle_UniformPriorsOneSigma_NoS_OneSigma_10000draws_AprilMayOnly.RData")
