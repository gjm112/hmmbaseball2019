...
#nohup R --vanilla  CMD BATCH  TwoStateModel_Pitchers_2017_UpdatedAfterArticle.R /home/gmatthews1/HMM/twoStateModel_Pitchers_2017_afterArticle_UniformPriorsOneSigma_NoS_OneSigma_10000draws.Rout
#pitch GROUP GROUP GROUP you moron.  NOT TYPE!!!!!!

#nohup R --vanilla CMD BATCH   /home/gmatthews1/HMM/TwoStateModel_Pitchers_2017_UpdatedAfterArticle_AprilMayOnly.R /home/gmatthews1/HMM/TwoStateModel_Pitchers_2017_UpdatedAfterArticle_AprilMayOnly.Rout
...
#Optional line of code.  Results of this smaller set will be used in prediction.  
data <- data[data$UTC<="2017-05-31 00:00:00",]
...
# 
# #Plot for paper
# jpeg("/Users/gregorymatthews/Dropbox/HMMbaseball/Manuscript/velHist2017.jpg")
# q <- ggplot(data = data, mapping = aes(x = start_speed_corr)) +
#   geom_histogram(aes(y=..density..)) +
#   geom_density(aes(y=..density..),colour="red") + xlab("velocity") +ggtitle("2017")+  xlim(75,105) + ylim(0,0.175)
# q
# dev.off()
# 
# jpeg("/Users/gregorymatthews/Dropbox/HMMbaseball/Manuscript/residHist2017.jpg")
# q <- ggplot(data = data, mapping = aes(x = resid)) +
#   geom_histogram(aes(y=..density..)) +
#   geom_density(aes(y=..density..),colour="red") + xlab("residual") +ggtitle("2017") + xlim(-20,10) + ylim(0,0.35)
# q
# dev.off()
# 
# 
...
# 
# jpeg("/Users/gregorymatthews/Dropbox/HMMbaseball/Manuscript/acf2017.jpg")
# q <- ggplot(data = bacfdf, mapping = aes(x = lag, y = acf)) +
#   geom_hline(aes(yintercept = 0)) +
#   geom_segment(mapping = aes(xend = lag, yend = 0)) + ggtitle("2017")
# q
# dev.off()
...
save.image("/home/gmatthews1/HMM/twoStateModel_Pitchers_2017_afterArticle_UniformPriorsOneSigma_NoS_OneSigma_10000draws_AprilMayOnly.RData")
